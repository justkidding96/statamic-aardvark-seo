<template>
    <div class="meta-field-validator__outer">
        <div class="meta-field-validator__field-container">
            ...
            <progress :max="meta.description_max_length || 160" :value="contentLength" :class="'meta-field-validator__progress meta-field-validator__progress--' + validation.step" />
        </div>
        ...
        methods: {
            ...
            validateMeta(length) {
                ...
                switch (true) {
                    ...
                    break;
                    case length >= 20 && length <= this.meta.description_max_length || 300:
                    validation = { step: "valid", caption: "Your meta description is a good length." };
                    break;
                    case length > this.meta.description_max_length || 300:
                    validation = {
                        step: "err",
                        caption:
                        `Your meta description is too long, <strong>the ideal length is between 50 and ${this.meta.description_max_length || 300} characters.</strong>`
                    };
                    break;
                }
                return validation;
