<template>
    <div class="meta-field-validator__outer">
        <div class="meta-field-validator__field-container">
            ...
            <progress :max="meta.title_max_length || 70" :value="contentLength" :class="'meta-field-validator__progress meta-field-validator__progress--' + validation.step" />
        </div>
            ...
            validateMeta(length) {
                ...
                switch (true) {
                    ...
                    case length < 20:
                        ...
                        break;
                    case length >= 20 && length <= this.meta.title_max_length || 70:
                        validation = { step: "valid", caption: "Your meta title is a good length." };
                    break;
                    case length > this.meta.title_max_length || 70:
                        validation = {
                            step: "err",
                            caption:
                            `Your meta title is too long, <strong>the ideal length is between 20 and ${this.meta.title_max_length || 70} characters.</strong>`
                        };
                    break;
                }
                return validation;
